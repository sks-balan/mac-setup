...
# 9. Set up spear_development symlink
echo "==> Setting up spear_development symlink..."
if [ -d "/Volumes/spear/logs/work/sbalan/development" ]; then
  ln -sf "/Volumes/spear/logs/work/sbalan/development" "$HOME/spear_development"
  echo "    Symlink created"
else
  echo "    WARNING: /Volumes/spear not mounted — skipping symlink"
fi
...
echo "    3. Source zsh config: source ~/.zshrc"
